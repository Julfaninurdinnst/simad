...
<body style="background:#4ec2f7">
    <div class="error-pagewrap " style="background:#4ec2f7">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3><img src="gambar/logo1.png" width= "10%" alt="Logo BPS">
                SIMAD BPS KOTA MEDAN</h3>
                <h4>Sistem Informasi Manajemen Arsip Digital</h4>
                <h5>Badan Pusat Statistik Kota Medan</h5>
        ...
        <div class="content-error " style="background:#4ec2f7">
                <?php 
                // pesan notifikasi
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="periksa_login.php" method="POST" id="loginForm">
                            ...
                            <input type="submit" class="btn btn-info btn-block loginbtn" value="Login">
                        </form>
                ...
                <a class="bg-info" href="index.php">Kembali</a>
            </div>
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Manajemen Arsip Digital (SIMAD)</p>
            </div>
        </div>   
    </div>
