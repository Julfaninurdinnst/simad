    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../gambar/logo.png" width="40%" style="margin-top: 10px" alt=""/> SIMAD BPS</a>
                <strong><a href="index.html"><img src="../gambar/logo.png" width="50%"alt=""></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="laporan.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">laporan</span></a>
                        </li>
                        <li>
        ...
        <div class="container-fluid">
            <div class="row">
                <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-info">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../gambar/logo.png" width="10%" alt="" />SIMAD BPS</a>
                    </div>
                </div> -->
            </div>
        </div>
